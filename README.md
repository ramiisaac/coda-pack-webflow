...
3. Use direct formulas or add the relevant sync tables for the resources you need.
...
2. Use `GetWebflowSite(siteId)` to verify site access.
3. Add one of the sync tables such as `Pages`, `Forms`, or `Orders` to bring Webflow data into a doc.
